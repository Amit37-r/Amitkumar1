...
export class PostAutomatorService {
            ...
            for (let attempt = 1; attempt <= PostAutomatorService.MAX_RETRIES + 1; attempt++) {
                try {
                    ...
                    if (attempt > PostAutomatorService.MAX_RETRIES) {
                        return { success: false, platform: request.platform, postedAt: new Date(), error: err.message };
                    }
    ...
    async login(page, platform, creds) {
        try {
    ...
    async composeAndPost(page, platform, text) {
        if (platform === 'linkedin') {
...
//# sourceMappingURL=post-automator.service.js.map