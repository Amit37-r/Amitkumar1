...
async function bootstrap(): Promise<void> {
  ...
  if (credentials.linkedin?.password) redactValues.push(credentials.linkedin.password);
  if (credentials.linkedin?.email) redactValues.push(credentials.linkedin.email);
  if (credentials.x?.password) redactValues.push(credentials.x.password);
  if (credentials.x?.username) redactValues.push(credentials.x.username);
